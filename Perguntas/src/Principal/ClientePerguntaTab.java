...
public class ClientePerguntaTab extends JFrame implements ActionListener {
	...
	public ClientePerguntaTab() throws IOException {
	...
	public static void main(String[] programa) throws IOException {
		ClientePerguntaTab pergunta = new ClientePerguntaTab();
